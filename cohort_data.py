...
def sort_by_cohort(filename):
    ...
    summer_15 = []
    tas = []
    for student in our_file:
        entry = student[0] + " "+ student[1]
        updated_entry = entry.lowercase()
        if len(student) > 4:
            if student[4] == "Winter 2015": 
                winter_15.append(updated_entry)
                print winter_15
            elif student[4] == "Spring 2015":
                spring_15.append(updated_entry)
            elif student[4] == "Summer 2015":
                summer_15.append(updated_entry)
        else: 
            tas.append(updated_entry)
